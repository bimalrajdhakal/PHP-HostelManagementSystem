    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-globe"></i> Mess Expenditure From  <?php echo $fromdate;?>  To  <?php echo $todate;?>
    ...
    <div class="row">
      <div class="col-xs-12 table-responsive">
		...
		<?php 
			...
			$query =$con->query("SELECT * FROM mess_invoice where date between '$fromdate' and '$todate' and customer_id='$stdid' ");
			$i=1;
			while($res=$query->fetch())
			   {
				   echo "<tr>";
                   echo "<td>".$i."</td>";
                   echo" <td>" ."<a href="."show_mess_bill_invoice.php?invoiceno=".$res['invoice_no'].">". $res['invoice_no'] ."</a></td>";
			...
			$query =$con->query("SELECT sum(amount) FROM mess_invoice where date between '$fromdate' and '$todate' and customer_id='$stdid' ");	
