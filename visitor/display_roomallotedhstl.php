...
if(isset($_GET['reqno']))
{
	...
	$query =$con->query("SELECT hostelid,visitorid FROM vstrrequest WHERE vstreqno='$reqno'");
	$res=$query->fetch();
	$hostelid=$res['hostelid'];
	$visitorid=$res['visitorid'];
	$query =$con->query("SELECT *FROM hostel_details WHERE hostel_id='$hostelid'");
	$result=$query->fetch();
	$queryselect =$con->query("SELECT room_no FROM visitor_room WHERE hostelid='$hostelid' AND allocatee_id='$visitorid'");
...
<html>
    ...
    <head>
        <title>Visitor Request Status</title>
        <!-- Bootstrap -->
            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					<!-- DISPLAYING hostel details  START -->			
                        <div class="block ">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><h4>Alloted Hostel Room Details</h4></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12 form-horizontal">
													<div class="control-group">
                                                      ...
                                                      <div class="controls">
														<input type="text"  class="span6 m-wrap" value="<?php echo $result['hostel_name'];?>" />
                                                      </div>
													</div>
													<div class="control-group">
													  <label class="control-label">Address<span class="required">:</span></label>
                                                      <div class="controls">
														<input type="text"  class="span6 m-wrap" value="<?php echo $result['addressline1'];?>"/>
														     <br>
															 <br>
														<input type="text"  class="span6 m-wrap" value="<?php echo $result['addressline2'];?>"/>
                                                      </div>
													</div>
													<div class="control-group">
													  <label class="control-label">District<span class="required">:</span></label>
                                                      <div class="controls">
														<input type="text"  class="span6 m-wrap" value="<?php echo $result['district'];?>" />
                                                      </div>
													</div>
													<div class="control-group">
													  <label class="control-label">State<span class="required">:</span></label>
                                                      <div class="controls">
														<input type="text"  class="span6 m-wrap" value="<?php echo $result['state'];?>" />
                                                      </div>
													</div>
													<div class="control-group">
													  <label class="control-label">PIN Code<span class="required">:</span></label>
                                                      <div class="controls">
														<input type="text"  class="span6 m-wrap" value="<?php echo $result['pincode'];?>" />
                                                      </div>
													</div>
													<div class="control-group">
													  <label class="control-label">Contact No.<span class="required">:</span></label>
                                                      <div class="controls">
														<input type="text"  class="span6 m-wrap" value="<?php echo $result['contactno'];?>" />
                                                      </div>
													</div>
													<div class="control-group">
													  <label class="control-label">Hostel Type<span class="required">:</span></label>
                                                      <div class="controls">
														<input type="text"  class="span6 m-wrap" value="<?php echo $result['hosteltype'];?>" />
                                                      </div>
													</div>
													<div class="control-group">
													  <label class="control-label">Alloted Room No<span class="required">:</span></label>
                                                      <div class="controls">
														<input type="text"  class="span6 m-wrap" value="<?php echo $data['room_no'];?>" />
                                                      </div>
													</div>
                                </div>
                            </div>
