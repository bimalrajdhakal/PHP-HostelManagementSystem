...
try{
	...
	$connect->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		if(isset($_POST['addservice']))
		{
			...
			$sql=("INSERT INTO laundry_invoice(customer_id,invoice_no,amount,date,bill_cycle,exp_delidate,status)
			VALUES (:custid,:invoice_no, :total ,:date, :bill_cycle, :exp_delidate, :status)");
