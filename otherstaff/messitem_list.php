    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Available Mess Item List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<?php 
			...
			$query =$con->query("SELECT * FROM messentry");
			$i=1;
			while($res=$query->fetch())
			{
				   echo "<tr>";
                   echo "<td>".$i."</td>";
                   echo" <td class="."mailbox-name>". $res['foodid']."</td>";
                   echo" <td class="."mailbox-name>".$res['fooditem'] ."</td> ";
