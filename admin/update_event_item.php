...
try{
	...
	$connect->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		if(isset($_POST['event_submit']))
		{
			...
			$sql=("UPDATE event_entry_table SET subject=:subject,event_date=:event_date,event_time=:event_time,description=:description WHERE id='$id'" );
...
echo "<title>Admin| Evenet Manage</title>";
?>
	...
	<div class="box-body">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Event Edit/Update</h4>
			</div>
				<?php
				    $con=new PDO ("mysql:host=localhost;dbname=hmsportal","root","");
					$con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
					$sql=("SELECT* FROM event_entry_table WHERE id='$id'");
					$query =$con->query($sql);
					$res=$query->fetch();		 				
				?>
			<div class="modal-body">
				<form class="form-horizontal" method="post" id="form-new-laun">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="date" class="form-control" name="eventdate" value="<?php echo $res['event_date'];?>">
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="control-label col-sm-3" >Time:</label>
				    <div class="col-sm-9">
				      <input type="time" class="form-control" name="eventtime" value="<?php echo $res['event_time'];?>" required>
				    </div>
				  </div>
	         	<div class="form-group">
