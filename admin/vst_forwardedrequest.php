...
<head>
  ...
  <title>Admin| Visitor Request</title>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Visitor's Forwarded Request</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<?php 
			...
			$query =$con->query("SELECT * FROM vstrrequest where vstreqstatus='Forwarded'");
			$i=1;
			while($res=$query->fetch())
			{
				   echo "<tr>";
                   echo "<td>".$i."</td>";
                   echo" <td class="."mailbox-name>" ."<a href="."vst_readforwardedreq.php?requestno=".$res['vstreqno'].">". $res['vstreqno'] ."</a></td>";
                   ...
                   echo" <td class="."mailbox>".$res['vstreqstatus']."</td>";
				   echo "</tr>";
				   $i++;
			}
		?>
