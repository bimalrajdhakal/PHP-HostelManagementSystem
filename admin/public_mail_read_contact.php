    ...
    <section class="content">
      <div class="row">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="public_mail_contact.php"><i class="fa fa-envelope-o"></i> Unread Messages
                  <span class="label label-primary pull-right"></span></a></li>
                <li><a href="public_mail_read_contact.php"><i class="fa fa-envelope-square"></i> Read Messages</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
		...
		<?php 
			...
			$query =$con->query("SELECT * FROM contact_us where status='Read' order by(messageid) DESC");
			$i=1;
