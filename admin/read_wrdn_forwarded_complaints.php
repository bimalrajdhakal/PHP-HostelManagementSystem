...
if(isset($_GET['complaintno']))
{
  ...
  if(isset($_POST['submitbtn']))
  {
		  ...
		  $queryupdate->execute(array(
							...
							$rectified=1;
			 header("location:wrdn_complaints_forwarded_list.php");
			}
...
echo "<title>Admin|Warden Forwarded Complaints</title>";
?>
...
?>
		 ...
		 <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Complaints Details </h3>
				...
				<?php
					$con=new PDO ("mysql:host=localhost;dbname=hmsportal","root","");
					$con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
					$query =$con->query("SELECT complaint_date,complaints_concern,description,roomno,attended_date FROM student_complaints WHERE complaints_no='$complaintno'");
					$res=$query->fetch();
				?>
				<br>
            ...
            <form method="post" class="form-horizontal">
	         	...
	         	<div class="form-group">
                  <label name="email" class="col-sm-3 control-label">Forwarded Date:</label>
            ...
            <div class="box-footer">
              <div class="pull-right">
                <a href=wrdn_complaints_forwarded_list.php><button type="button" name="addservice" class="btn btn-default pull-right"><i class="fa fa-reply"></i> Back</button></a>
              </div>
