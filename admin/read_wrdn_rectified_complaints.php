...
echo "<title>Admin|Rectified Complaints</title>";
?>
		 ...
		 <div class="box box-info">
		    ...
		    <div class="box-footer">
              <div class="pull-right">
                 <a href=wrdn_complaints_rectified_list.php><button type="button" name="addservice" class="btn btn-default pull-right"><i class="fa fa-reply"></i> Back</button></a>
              </div>
			</div>
			</form>
			<!-- form End -->
