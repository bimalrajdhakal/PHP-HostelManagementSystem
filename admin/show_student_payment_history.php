    ...
    <section class="content">
      <div class="row">
         <div class="col-md-12">
		  ...
		  <div class="control-group alert alert-danger text-danger <?php if(!isset($error)) echo 'hide';?>">
                  No data to display , perhaps you entered wrong Student ID or Student doesm't have any Transation Record!
          </div>
                <br>
             <!-- TABLE START  -->
	  ...
	  <?php 
		...
		?>
		  ...
		  <div class="control-group alert alert-danger text-danger <?php if(!isset($error)) echo 'hide';?>">
                  No data to display , perhaps you entered wrong Student ID or Student doesn't have any Transation Record!
          </div>
