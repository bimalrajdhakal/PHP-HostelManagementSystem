...
if(isset($_GET['complaintno']))
{
  ...
  if(isset($_POST['forwardbtn']))
  {
		  ...
		  $attended_date=Date("Y-m-d");
		  $complaint_status='Forwarded';
		  $updatestmt=("UPDATE student_complaints SET attended_date =:attended_date, complaint_status =:complaint_status WHERE complaints_no='$complaintno'");
		  $queryupdate =$con->prepare($updatestmt);
		  $queryupdate->execute(array(
		                            ':attended_date'=>$attended_date,
									':complaint_status'=>$complaint_status)
		 ...
		 <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Complaints Details </h3>
	            ...
	            <div class="alert alert-success alert-dismissible <?php if(!isset($forwarded)) echo 'hide';?>">
				   <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
				   <h5><i class="icon fa fa-check"></i>Complaint Forwarded Sucessfully to Complaint No-<?php echo $complaintno;?></h5>
				</div>
            ...
            <div class="box-footer">
              <div class="pull-right">
				<a href=std_complaints_new_list.php><button type="button" name="backbtn" class="btn btn-default"><i class="fa fa-reply"></i> Back</button></a>
              </div>
