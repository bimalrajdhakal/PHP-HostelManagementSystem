...
<head>
  ...
  <title>Warden| Student Request</title>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Student's Accepted Request</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<?php 
			...
			$query =$con->query("SELECT * FROM stdrequest where req_status='Accepted' and hostelid='$stafflogedin_hostel_id'");
			$i=1;
			while($res=$query->fetch())
			{
				   echo "<tr>";
                   echo "<td>".$i."</td>";
                   echo" <td class="."mailbox-name>" ."<a href="."std_readacceptedreq.php?requestno=".$res['requestno'].">". $res['requestno'] ."</a></td>";
                   echo" <td class="."mailbox-subject>"."<b>"."<a href="."display_allocatee_details.php?studentid=".$res['stdudent_id']." target="."_blank".">".$res['stdudent_id'] ."</b> ";
                   echo "</td>";
