...
<head>
  ...
  <title>Warden| Show Out Student</title>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Show Out Students</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<?php 
			...
			while($res=$query->fetch())
			{
				 echo "<tr>";
                 echo "<td>".$i."</td>";
                 echo" <td class="."mailbox-name>" ."<a href="."stdinupdate.php?id=".$res['id'].">"."View/Update"."</a>"."</td>";
                 ...
                 echo "</td>";
                 echo" <td class="."mailbox-attachment>". Date("d-m-Y",strtotime($res['out_date']))."</td>";
                 echo" <td class="."mailbox>".Date("h:i a",strtotime($res['out_time']))."</td>";
