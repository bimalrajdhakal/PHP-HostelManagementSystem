		 ...
		 <div class="box box-info">
            ...
            <form method="post" class="form-horizontal">
	         	...
	         	<div class="form-group">
                  ...
                  <div class="col-xs-5">
                    <input type="text" class="form-control" name="vacatedate" value="<?php echo Date("d-m-Y",strtotime($res['req_granted_date']));?>">
                  </div>
                </div>
	         	<div class="form-group">
                  <label name="email" class="col-sm-3 control-label">Student Date:</label>
                  <div class="col-xs-5">
                    <input type="text" class="form-control" name="vacatedate" value="<?php echo $res['status'];?>">
                  </div>
                </div>
            <!-- /.box-footer -->
            <div class="box-footer">
              <div class="pull-right">
				<a href=std_hostel_vacate_request_approved_list.php><button type="button" name="backbtn" class="btn btn-default"><i class="fa fa-reply"></i> Back</button></a>
              </div>
            </div>
			</form>
			<!-- form End -->
