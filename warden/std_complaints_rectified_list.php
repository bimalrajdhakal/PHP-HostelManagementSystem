    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Student's Rectified Complaints List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<?php 
			...
			$query =$con->query("SELECT * FROM student_complaints where complaint_status='Rectified' and hostel_id='$stafflogedin_hostel_id'");
			$i=1;
			while($res=$query->fetch())
			{
				   echo "<tr>";
                   echo "<td>".$i."</td>";
                   echo" <td class="."mailbox-name>" ."<a href="."read_std_rectified_complaints.php?complaintno=".$res['complaints_no'].">". $res['complaints_no'] ."</a></td>";
