		 ...
		 <div class="box box-info">
            ...
            <form class="form-horizontal">
	         	...
	         	<div class="form-group hide">
                  ...
                  <div class="col-xs-5">
                    <input type="text" class="form-control"  value="<?php echo $res['hostel_id'];?>">
                  </div>
                </div>
	         	<div class="form-group hide">
                  <label name="email" class="col-sm-3 control-label">Student ID:</label>
                  <div class="col-xs-5">
                    <input type="text" class="form-control"  value="<?php echo $res['student_id'];?>">
                  </div>
                </div>
	         	<div class="form-group">
                  <label name="email" class="col-sm-3 control-label">Current Room No:</label>
                  <div class="col-xs-5">
                    <input type="text" class="form-control"  value="<?php echo $res['currentroomno'];?>">
                  </div>
                </div>
	         	<div class="form-group">
                  <label name="email" class="col-sm-3 control-label">Willing Room No:</label>
                  <div class="col-xs-5">
                    <input type="text" class="form-control"  value="<?php echo $res['willingroomno'];?>">
                  </div>
                </div>
	         	<div class="form-group">
			...
			<!-- form End -->
              <div class="pull-right">
				<a href=std_room_change_request_approved_list.php><button type="button" name="backbtn" class="btn btn-default"><i class="fa fa-reply"></i> Back</button></a>
              </div>
            </div>
	 	  </div>
	     </div>
